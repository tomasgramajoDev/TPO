...
- [Guía DevOps desde cero](../output/pdf/Guia_DevOps_Obras_Publicas_Desde_Cero.pdf): explicación lógica y accesible del recorrido completo, desde el código del equipo hasta Azure, con ejemplos, analogías, operación diaria y pendientes reales.
